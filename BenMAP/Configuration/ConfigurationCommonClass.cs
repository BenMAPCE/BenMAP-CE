...
.Replace("acos(", "ACOS_TOKEN(").Replace("acos (", "ACOS_TOKEN(")
.Replace("cos(", "Math.Cos(").Replace("cos (", "Math.Cos(")
.Replace("ACOS_TOKEN(", "Math.Acos(")
.Replace("asin(", "ASIN_TOKEN(").Replace("asin (", "ASIN_TOKEN(")
.Replace("sin(", "Math.Sin(").Replace("sin (", "Math.Sin(")
.Replace("ASIN_TOKEN(", "Math.Asin(")
.Replace("atan(", "ATAN_TOKEN(").Replace("atan (", "ATAN_TOKEN(")
.Replace("tan(", "Math.Tan(").Replace("tan (", "Math.Tan(")
.Replace("ATAN_TOKEN(", "Math.Atan(")
...
.Replace("truncate(", "Math.Truncate(").Replace("truncate (", "Math.Truncate(");
		...
		public static void getSetupVariableNameListFromDatabaseFunction(int VariableDatasetID, int GridDefinitionID, string DatabaseFunction, List<Tuple<string, int>> SystemVariableNameList, ref List<SetupVariableJoinAllValues> lstFunctionVariables)
		{
			try
			{
				...
				//exclude default function variables
				...
				//exclude math function names BENMAP-588 (use name + "(" to identify math functions names instead of just using function name "cos")
				DatabaseFunction = DatabaseFunction.Replace("abs(", "( ")
.Replace("acos(", " (")
.Replace("asin(", " (")
.Replace("atan(", " (")
.Replace("atan2(", " (")
