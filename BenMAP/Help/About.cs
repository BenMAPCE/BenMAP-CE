...
namespace BenMAP
{
    partial class About : FormBase
    {
        ...
        public string AssemblyVersion
        {
            get
            {
                return Assembly.GetExecutingAssembly().GetName().Version.ToString().Substring(0, Assembly.GetExecutingAssembly().GetName().Version.ToString().Count() - 2) + " (September 25, 2014)";
            }
        }
