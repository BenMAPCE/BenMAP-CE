...
namespace PopSim
{
    public partial class frm_PopSim : Form
    {
        ...
        public frm_PopSim()
        {
            ...
            dbConnection = PopSim.frm_PopSim.getNewConnection();
            dbConnection.Open();
        ...
        private void bwOutput_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            {    // output reports to csv files
                ...
                outputRoutine.queryStringToXTabFile("Select Age, Year_Num, Sum(Increase_Male) as Increase_Male from  "
                    + " RPT_INC_PRD_COND_LIFE_EXP GROUP BY Age, Year_Num", fileName + "_Report_Increase_PCLE_Male.csv",
                ...
                outputRoutine.queryStringToXTabFile("Select Age, Year_Num, Sum(Increase_Female) as Increase_Female from  "
                    + " RPT_INC_PRD_COND_LIFE_EXP GROUP BY Age, Year_Num", fileName + "_Report_Increase_PCLE_Female.csv",
                    "Age", "Year_Num", "Increase_Female");

                bwOutput.ReportProgress(30);
                outputRoutine.queryStringToXTabFile("Select Age, Year_Num, Sum(Increase_Male) as Increase_Male from  "
                                + " RPT_INC_COHORT_COND_LIFE_EXP GROUP BY Age, Year_Num", fileName + "_Report_Increase_CCLE_Male.csv",
                                "Age", "Year_Num", "Increase_Male");
                
                bwOutput.ReportProgress(40);
                outputRoutine.queryStringToXTabFile("Select Age, Year_Num, Sum(Increase_Female) as Increase_Female from  "
                    + " RPT_INC_COHORT_COND_LIFE_EXP GROUP BY Age, Year_Num", fileName + "_Report_Increase_CCLE_Female.csv",
                    "Age", "Year_Num", "Increase_Female");
                ...
                outputRoutine.queryStringToXTabFile("Select Age, Year_Num, Sum(Life_Years_Gained) as Life_Years_Gained "
                    + "FROM Report_Life_Years_Gained Group By Age, Year_Num ", fileName + "_Report_Life_Years_Gained_Xtab.csv",
                ...
                outputRoutine.queryStringToXTabFile("SELECT Age, Year_Num, Sum(Avoided_Deaths) AS Avoided_Deaths "
                    + " FROM Report_Avoided_Deaths GROUP BY Age, Year_Num ORDER BY Age, Year_Num", fileName + "_Report_Avoided_Deaths_Xtab.csv",
                    "Age", "Year_Num", "Avoided_Deaths");


                bwOutput.ReportProgress(80);
                outputRoutine.queryStringToFile("Select * from Report_Beta_Summary", fileName + "_Report_Beta_Summary.csv");
                
                bwOutput.ReportProgress(90);
                outputRoutine.queryStringToFile("Select * from Report_Input_Summary", fileName + "_Report_Input_Summary.csv");
