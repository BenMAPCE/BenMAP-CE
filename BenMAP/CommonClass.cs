...
other.Features[iotherFeature].Distance(new Point(selfFeature.Envelope.Minimum.X, selfFeature.Envelope.Maximum.Y)) == 0
    ...
    public enum enumDatabaseExport
    {
        ...
        // BENMAP-520 - BRDX (database export) - removed QalyDatasets as they are no longer included in the MP database (unused and now removed)        
    }
    ...
    public class MonitorDataHelper
    {
        ...
        public bool Is365;
        public int DayCount;
        public List<float> Base365Values;
        public List<float> Control365Values;
