...
| System.Windows.Forms.AnchorStyles.Right)));
			...
			this.groupBox1.Controls.Add(this.txtPoolingWindowName);
...
| System.Windows.Forms.AnchorStyles.Right)));
			...
			this.treeListView.AllColumns.Add(this.olvColumn22);
			this.treeListView.AllColumns.Add(this.olvColumn23);
			this.treeListView.AllColumns.Add(this.olvColumn24);
			this.treeListView.AllColumns.Add(this.olvColumn25);
			this.treeListView.AllColumns.Add(this.olvColumn26);
			this.treeListView.AllColumns.Add(this.olvColumn27);
			this.treeListView.AllColumns.Add(this.olvColumn28);
			...
			this.treeListView.Location = new System.Drawing.Point(3, 18);
			...
			this.treeListView.Size = new System.Drawing.Size(766, 422);
			this.treeListView.TabIndex = 16;
...
"ntValue";
			...
			this.Name = "SelectSubjectiveWeight";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Select User Defined Weight";
			this.Load += new System.EventHandler(this.SelectSubjectiveWeight_Load);
			this.TextChanged += new System.EventHandler(this.SelectSubjectiveWeight_TextChanged);
