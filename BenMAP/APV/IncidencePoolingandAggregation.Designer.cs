namespace BenMAP
{
    partial class IncidencePoolingandAggregation
    {
        ...
        private void InitializeComponent()
        {
			...
			this.splitContainerTile = new System.Windows.Forms.SplitContainer();
			this.tabControlSelected = new System.Windows.Forms.TabControl();
			this.PoolingWindow0 = new System.Windows.Forms.TabPage();
			...
			this.btOLVTileSet = new System.Windows.Forms.Button();
			this.olvTile = new BrightIdeasSoftware.ObjectListView();
			this.btDelSelectMethod = new System.Windows.Forms.Button();
			...
			((System.ComponentModel.ISupportInitialize)(this.splitContainerTile)).BeginInit();
			this.splitContainerTile.Panel1.SuspendLayout();
			this.splitContainerTile.Panel2.SuspendLayout();
			this.splitContainerTile.SuspendLayout();
			this.tabControlSelected.SuspendLayout();
			this.PoolingWindow0.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.treeListView)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.olvTile)).BeginInit();
			...
			this.miniToolStrip.Location = new System.Drawing.Point(988, 23);
			this.miniToolStrip.Name = "miniToolStrip";
			this.miniToolStrip.Size = new System.Drawing.Size(986, 22);
			this.miniToolStrip.TabIndex = 9;
			// 
			// btChangeName
			// 
			this.btChangeName.Location = new System.Drawing.Point(1467, 35);
			this.btChangeName.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.btChangeName.Name = "btChangeName";
			this.btChangeName.Size = new System.Drawing.Size(28, 42);
        ...
        "ey \'Enter\'");
			...
			this.splitContainer1.Size = new System.Drawing.Size(1656, 1127);
			...
			// 
			this.grpAvailabelIncidenceResults.BackColor = System.Drawing.SystemColors.Control;
			this.grpAvailabelIncidenceResults.Controls.Add(this.groupBox10);
			this.grpAvailabelIncidenceResults.Controls.Add(this.groupBox8);
			this.grpAvailabelIncidenceResults.Dock = System.Windows.Forms.DockStyle.Fill;
			this.grpAvailabelIncidenceResults.Font = new System.Drawing.Font("Calibri", 9F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.grpAvailabelIncidenceResults.Location = new System.Drawing.Point(0, 0);
			this.grpAvailabelIncidenceResults.Margin = new System.Windows.Forms.Padding(4, 0, 4, 5);
			this.grpAvailabelIncidenceResults.Name = "grpAvailabelIncidenceResults";
			this.grpAvailabelIncidenceResults.Padding = new System.Windows.Forms.Padding(4, 5, 0, 5);
			this.grpAvailabelIncidenceResults.Size = new System.Drawing.Size(1656, 517);
			this.grpAvailabelIncidenceResults.TabIndex = 0;
			this.grpAvailabelIncidenceResults.TabStop = false;
			this.grpAvailabelIncidenceResults.Text = "1. Select Available Incidence Results";
			// 
			// groupBox10
			// 
			...
			this.groupBox10.Location = new System.Drawing.Point(4, 135);
			this.groupBox10.Margin = new System.Windows.Forms.Padding(4, 0, 4, 5);
			this.groupBox10.Name = "groupBox10";
			this.groupBox10.Padding = new System.Windows.Forms.Padding(4, 0, 4, 5);
			this.groupBox10.Size = new System.Drawing.Size(1652, 377);
			...
			this.olvAvailable.AllColumns.Add(this.olvColumn9);
			this.olvAvailable.AllColumns.Add(this.olvColumn12);
			this.olvAvailable.AllColumns.Add(this.olvColumn13);
			this.olvAvailable.AllColumns.Add(this.olvColumn14);
			this.olvAvailable.AllColumns.Add(this.olvColumn15);
			this.olvAvailable.AllColumns.Add(this.olvColumn16);
			...
			this.olvAvailable.AllColumns.Add(this.olvColumn40);
			this.olvAvailable.AllColumns.Add(this.olvColumn41);
			this.olvAvailable.AllColumns.Add(this.olvColumn42);
			this.olvAvailable.AllColumns.Add(this.olvColumn43);
			this.olvAvailable.AllColumns.Add(this.olvColumn44);
			this.olvAvailable.AllColumns.Add(this.olvColumn45);
			this.olvAvailable.AllColumns.Add(this.olvColumn46);
			this.olvAvailable.AllColumns.Add(this.olvColumn47);
			this.olvAvailable.AllColumns.Add(this.olvColumn48);
			this.olvAvailable.AllColumns.Add(this.olvColumn49);
			this.olvAvailable.AllColumns.Add(this.olvColumn50);
			...
			this.olvAvailable.Font = new System.Drawing.Font("Calibri", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.olvAvailable.FullRowSelect = true;
			this.olvAvailable.HideSelection = false;
			this.olvAvailable.IsSimpleDragSource = true;
			this.olvAvailable.IsSimpleDropSink = true;
			this.olvAvailable.Location = new System.Drawing.Point(4, 75);
			this.olvAvailable.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			...
			this.olvAvailable.Size = new System.Drawing.Size(1644, 297);
			this.olvAvailable.SmallImageList = this.imageList1;
			this.olvAvailable.SpaceBetweenGroups = 20;
			this.olvAvailable.TabIndex = 2;
			...
			this.olvcDataSet.IsTileViewColumn = true;
			this.olvcDataSet.Text = "Dataset Name";
			this.olvcDataSet.Width = 114;
			// 
			// olvColumn8
			// 
			...
			// olvColumn35
			// 
			this.olvColumn35.AspectName = "CRSelectFunction.BenMAPHealthImpactFunction.Percentile";
			this.olvColumn35.DisplayIndex = 11;
			...
			this.olvColumn38.DisplayIndex = 14;
			...
			// olvColumn39
			// 
			this.olvColumn39.AspectName = "CRSelectFunction.BenMAPHealthImpactFunction.OtherPollutants";
			this.olvColumn39.DisplayIndex = 15;
			...
			this.olvColumn40.DisplayIndex = 16;
			...
			this.olvColumn41.DisplayIndex = 17;
			...
			this.olvColumn42.DisplayIndex = 18;
			...
			this.olvColumn43.DisplayIndex = 19;
			...
			this.olvColumn44.DisplayIndex = 20;
			...
			this.olvColumn45.DisplayIndex = 21;
			...
			this.olvColumn46.DisplayIndex = 22;
			...
			this.olvColumn47.DisplayIndex = 23;
			...
			this.olvColumn48.DisplayIndex = 24;
			...
			this.olvColumn49.DisplayIndex = 25;
			...
			this.olvColumn50.DisplayIndex = 26;
			...
			this.olvColumn51.DisplayIndex = 27;
			...
			this.olvColumn52.DisplayIndex = 28;
			...
			// olvColumn4
			// 
			this.olvColumn4.AspectName = "CRSelectFunction.BenMAPHealthImpactFunction.Year";
			...
			this.groupBox4.Location = new System.Drawing.Point(4, 75);
			this.groupBox4.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.groupBox4.Name = "groupBox4";
			this.groupBox4.Padding = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.groupBox4.Size = new System.Drawing.Size(1644, 297);
			...
			this.groupBox11.Location = new System.Drawing.Point(4, 22);
			this.groupBox11.Margin = new System.Windows.Forms.Padding(4, 0, 4, 5);
			this.groupBox11.Name = "groupBox11";
			this.groupBox11.Padding = new System.Windows.Forms.Padding(4, 0, 4, 5);
			this.groupBox11.Size = new System.Drawing.Size(1644, 53);
			...
			// btAddStudy
			// 
			this.btAddStudy.Location = new System.Drawing.Point(9, 6);
			this.btAddStudy.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.btAddStudy.Name = "btAddStudy";
			this.btAddStudy.Size = new System.Drawing.Size(270, 42);
			this.btAddStudy.TabIndex = 0;
			this.btAddStudy.Text = "Add to Pooling Window";
			this.btAddStudy.UseVisualStyleBackColor = true;
			this.btAddStudy.Click += new System.EventHandler(this.btAddStudy_Click);
			// 
			// btAddAllStudy
			// 
			this.btAddAllStudy.Location = new System.Drawing.Point(288, 6);
			this.btAddAllStudy.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.btAddAllStudy.Name = "btAddAllStudy";
			this.btAddAllStudy.Size = new System.Drawing.Size(117, 42);
			this.btAddAllStudy.TabIndex = 2;
			this.btAddAllStudy.Text = "Add All";
			...
			this.groupBox8.Font = new System.Drawing.Font("Calibri", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.groupBox8.Location = new System.Drawing.Point(4, 27);
			this.groupBox8.Margin = new System.Windows.Forms.Padding(4, 5, 0, 5);
			this.groupBox8.Name = "groupBox8";
			this.groupBox8.Padding = new System.Windows.Forms.Padding(4, 5, 0, 5);
			this.groupBox8.Size = new System.Drawing.Size(1652, 108);
			this.groupBox8.TabIndex = 0;
			this.groupBox8.TabStop = false;
			// 
			// btnShowChanges
			// 
			this.btnShowChanges.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			...
			this.btnShowChanges.Location = new System.Drawing.Point(1476, 36);
			this.btnShowChanges.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.btnShowChanges.Name = "btnShowChanges";
			this.btnShowChanges.Size = new System.Drawing.Size(172, 47);
			...
			this.groupBox5.Size = new System.Drawing.Size(252, 79);
			...
			this.cbDataSet.Location = new System.Drawing.Point(4, 27);
			this.cbDataSet.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.cbDataSet.Name = "cbDataSet";
			this.cbDataSet.Size = new System.Drawing.Size(244, 30);
			...
			this.btTileSet.Location = new System.Drawing.Point(1288, 36);
			this.btTileSet.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.btTileSet.Name = "btTileSet";
			this.btTileSet.Size = new System.Drawing.Size(180, 47);
			...
			// cbGroups
			// 
			this.cbGroups.Location = new System.Drawing.Point(843, 41);
			this.cbGroups.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.cbGroups.Name = "cbGroups";
			this.cbGroups.Size = new System.Drawing.Size(105, 41);
			...
			this.groupBox9.Location = new System.Drawing.Point(506, 17);
			...
			this.comboBox1.Size = new System.Drawing.Size(115, 30);
			this.comboBox1.TabIndex = 22;
			// 
			// textBoxFilterSimple
			// 
			this.textBoxFilterSimple.Dock = System.Windows.Forms.DockStyle.Fill;
			this.textBoxFilterSimple.Location = new System.Drawing.Point(4, 27);
			this.textBoxFilterSimple.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.textBoxFilterSimple.Name = "textBoxFilterSimple";
			this.textBoxFilterSimple.Size = new System.Drawing.Size(148, 29);
			...
			this.groupBox3.Location = new System.Drawing.Point(261, 17);
			...
			this.cbEndPointGroup.Location = new System.Drawing.Point(4, 27);
			this.cbEndPointGroup.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.cbEndPointGroup.Name = "cbEndPointGroup";
			this.cbEndPointGroup.Size = new System.Drawing.Size(228, 30);
			...
			// groupBox7
			// 
			this.groupBox7.Controls.Add(this.grpSelectPoolingMethods);
			this.groupBox7.Dock = System.Windows.Forms.DockStyle.Fill;
			this.groupBox7.Location = new System.Drawing.Point(0, 0);
			this.groupBox7.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.groupBox7.Name = "groupBox7";
			this.groupBox7.Padding = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.groupBox7.Size = new System.Drawing.Size(1656, 604);
			this.groupBox7.TabIndex = 0;
			this.groupBox7.TabStop = false;
			// 
			// grpSelectPoolingMethods
			// 
			this.grpSelectPoolingMethods.Controls.Add(this.groupBox6);
			this.grpSelectPoolingMethods.Controls.Add(this.groupBox2);
			this.grpSelectPoolingMethods.Dock = System.Windows.Forms.DockStyle.Fill;
			this.grpSelectPoolingMethods.Font = new System.Drawing.Font("Calibri", 9F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.grpSelectPoolingMethods.Location = new System.Drawing.Point(4, 27);
			this.grpSelectPoolingMethods.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.grpSelectPoolingMethods.Name = "grpSelectPoolingMethods";
			this.grpSelectPoolingMethods.Padding = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.grpSelectPoolingMethods.Size = new System.Drawing.Size(1648, 572);
			this.grpSelectPoolingMethods.TabIndex = 0;
			this.grpSelectPoolingMethods.TabStop = false;
			this.grpSelectPoolingMethods.Text = "2. Select Pooling Methods";
			// 
			// groupBox6
			// 
			...
			this.groupBox6.Controls.Add(this.txtOpenExistingCFGR);
			this.groupBox6.Controls.Add(this.splitContainerTile);
			this.groupBox6.Controls.Add(this.btDelSelectMethod);
			this.groupBox6.Controls.Add(this.btnNext);
			this.groupBox6.Controls.Add(this.btnAdvanced);
			...
			this.groupBox6.Size = new System.Drawing.Size(1640, 463);
			...
			this.btPoolingPreview.Location = new System.Drawing.Point(1079, 413);
			this.btPoolingPreview.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.btPoolingPreview.Name = "btPoolingPreview";
			this.btPoolingPreview.Size = new System.Drawing.Size(112, 42);
			...
			this.label4.Location = new System.Drawing.Point(174, 423);
			...
			this.btBrowseCR.Location = new System.Drawing.Point(778, 413);
			this.btBrowseCR.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.btBrowseCR.Name = "btBrowseCR";
			this.btBrowseCR.Size = new System.Drawing.Size(51, 42);
			...
			// txtOpenExistingCFGR
			// 
			this.txtOpenExistingCFGR.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
			this.txtOpenExistingCFGR.Location = new System.Drawing.Point(424, 416);
			this.txtOpenExistingCFGR.Margin = new System.Windows.Forms.Padding(6, 8, 6, 8);
			this.txtOpenExistingCFGR.Name = "txtOpenExistingCFGR";
			this.txtOpenExistingCFGR.ReadOnly = true;
			this.txtOpenExistingCFGR.Size = new System.Drawing.Size(331, 29);
			...
			// 
			// splitContainerTile.Panel1
			// 
			this.splitContainerTile.Panel1.Controls.Add(this.tabControlSelected);
			// 
			// splitContainerTile.Panel2
			// 
			this.splitContainerTile.Panel2.Controls.Add(this.btOLVTileSet);
			this.splitContainerTile.Panel2.Controls.Add(this.olvTile);
			this.splitContainerTile.Panel2.Font = new System.Drawing.Font("Calibri", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.splitContainerTile.Panel2MinSize = 0;
			this.splitContainerTile.Size = new System.Drawing.Size(1649, 382);
			this.splitContainerTile.SplitterDistance = 1293;
			this.splitContainerTile.SplitterWidth = 6;
			this.splitContainerTile.TabIndex = 11;
			// 
			// tabControlSelected
			// 
			this.tabControlSelected.Controls.Add(this.PoolingWindow0);
			this.tabControlSelected.Dock = System.Windows.Forms.DockStyle.Fill;
			this.tabControlSelected.Font = new System.Drawing.Font("Calibri", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.tabControlSelected.Location = new System.Drawing.Point(0, 0);
			this.tabControlSelected.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.tabControlSelected.Name = "tabControlSelected";
			this.tabControlSelected.SelectedIndex = 0;
			this.tabControlSelected.Size = new System.Drawing.Size(1293, 382);
			...
			// PoolingWindow0
			// 
			this.PoolingWindow0.Controls.Add(this.treeListView);
			this.PoolingWindow0.Location = new System.Drawing.Point(4, 31);
			this.PoolingWindow0.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.PoolingWindow0.Name = "PoolingWindow0";
			this.PoolingWindow0.Padding = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.PoolingWindow0.Size = new System.Drawing.Size(1285, 347);
			this.PoolingWindow0.TabIndex = 0;
			this.PoolingWindow0.Text = "PoolingWindow0";
			this.PoolingWindow0.UseVisualStyleBackColor = true;
			// 
			// treeListView
			// 
			...
			this.treeListView.AllColumns.Add(this.olvColumn21);
			...
			this.treeListView.AllColumns.Add(this.olvColumn53);
			this.treeListView.AllColumns.Add(this.olvColumn54);
			this.treeListView.AllColumns.Add(this.olvColumn11);
			this.treeListView.AllColumns.Add(this.olvColumn55);
			...
			this.treeListView.Location = new System.Drawing.Point(4, 17);
			this.treeListView.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			...
			this.treeListView.Size = new System.Drawing.Size(1274, 447);
			...
			this.olvColumn1.HeaderImageKey = "headerE";
			...
			this.olvColumnWeight.HeaderFormatStyle = this.olvHdrStylePooling;
			this.olvColumnWeight.HeaderImageKey = "headerE";
			...
			// olvColumn21
			// 
			this.olvColumn21.AspectName = "Nickname";
			this.olvColumn21.HeaderForeColor = System.Drawing.Color.FromArgb(((int)(((byte)(192)))), ((int)(((byte)(0)))), ((int)(((byte)(192)))));
			this.olvColumn21.HeaderFormatStyle = this.olvHdrStylePooling;
			this.olvColumn21.HeaderImageKey = "headerE";
			this.olvColumn21.Text = "Nickname";
			// 
			// olvColumn31
			// 
			this.olvColumn31.AspectName = "EndPoint";
			this.olvColumn31.IsEditable = false;
			this.olvColumn31.Text = "Endpoint";
			// 
			// olvColumn30
			// 
			this.olvColumn30.AspectName = "Author";
			this.olvColumn30.IsEditable = false;
			this.olvColumn30.Text = "Author";
			// 
			// olvColumn6
			// 
    ...
    "ations";
			...
			// olvColumn32
			// 
			this.olvColumn32.AspectName = "StartAge";
			this.olvColumn32.IsEditable = false;
			this.olvColumn32.Text = "Start Age";
			// 
			// olvColumn33
			// 
			this.olvColumn33.AspectName = "EndAge";
			this.olvColumn33.IsEditable = false;
			this.olvColumn33.Text = "End Age";
			// 
			// olvColumn20
			// 
    ...
    "tName";
			...
			// btOLVTileSet
			// 
			this.btOLVTileSet.Location = new System.Drawing.Point(6, 17);
			this.btOLVTileSet.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.btOLVTileSet.Name = "btOLVTileSet";
			this.btOLVTileSet.Size = new System.Drawing.Size(172, 36);
			...
			this.olvTile.EmptyListMsg = "This list is empty.";
			this.olvTile.FullRowSelect = true;
			this.olvTile.HideSelection = false;
			this.olvTile.IsSimpleDragSource = true;
			this.olvTile.IsSimpleDropSink = true;
			this.olvTile.Location = new System.Drawing.Point(6, 53);
			this.olvTile.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.olvTile.Name = "olvTile";
			this.olvTile.OverlayText.Alignment = System.Drawing.ContentAlignment.BottomLeft;
			this.olvTile.OverlayText.BorderColor = System.Drawing.Color.FromArgb(((int)(((byte)(192)))), ((int)(((byte)(192)))), ((int)(((byte)(0)))));
			this.olvTile.OverlayText.BorderWidth = 2F;
			this.olvTile.OverlayText.Rotation = -20;
			this.olvTile.OverlayText.Text = "";
			this.olvTile.SelectColumnsOnRightClickBehaviour = BrightIdeasSoftware.ObjectListView.ColumnSelectBehaviour.Submenu;
			this.olvTile.ShowCommandMenuOnRightClick = true;
			this.olvTile.ShowGroups = false;
			...
			this.olvTile.UseAlternatingBackColors = true;
			this.olvTile.UseCompatibleStateImageBehavior = false;
			this.olvTile.UseFiltering = true;
			this.olvTile.UseHotItem = true;
			...
			// btDelSelectMethod
			// 
			this.btDelSelectMethod.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
			this.btDelSelectMethod.Location = new System.Drawing.Point(0, 413);
			this.btDelSelectMethod.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.btDelSelectMethod.Name = "btDelSelectMethod";
			this.btDelSelectMethod.Size = new System.Drawing.Size(170, 42);
			...
			this.btnNext.Location = new System.Drawing.Point(1518, 413);
			...
			this.btnAdvanced.Location = new System.Drawing.Point(1262, 413);
			this.btnAdvanced.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.btnAdvanced.Name = "btnAdvanced";
			this.btnAdvanced.Size = new System.Drawing.Size(126, 42);
			...
			this.btnCancel.Location = new System.Drawing.Point(1397, 413);
			...
			this.groupBox2.Controls.Add(this.btRemoveAllStudy);
			this.groupBox2.Controls.Add(this.label3);
			this.groupBox2.Controls.Add(this.btRemoveStudy);
			...
			this.groupBox2.Size = new System.Drawing.Size(1640, 77);
			...
			this.label5.Location = new System.Drawing.Point(1224, 25);
    ...
    "grouping, etc.";
			...
			this.label6.Location = new System.Drawing.Point(1192, 22);
			...
			// btRemoveAllStudy
			// 
			this.btRemoveAllStudy.Location = new System.Drawing.Point(160, 25);
			this.btRemoveAllStudy.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.btRemoveAllStudy.Name = "btRemoveAllStudy";
			this.btRemoveAllStudy.Size = new System.Drawing.Size(219, 42);
			...
			this.label3.Location = new System.Drawing.Point(958, 38);
			...
			// btRemoveStudy
			// 
			this.btRemoveStudy.Location = new System.Drawing.Point(9, 25);
			this.btRemoveStudy.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.btRemoveStudy.Name = "btRemoveStudy";
			this.btRemoveStudy.Size = new System.Drawing.Size(142, 42);
			...
			this.cbPoolLevel.Size = new System.Drawing.Size(61, 30);
			...
			// tbPoolingName
			// 
			this.tbPoolingName.Location = new System.Drawing.Point(606, 33);
			this.tbPoolingName.Margin = new System.Windows.Forms.Padding(6, 8, 6, 8);
			this.tbPoolingName.Name = "tbPoolingName";
			this.tbPoolingName.Size = new System.Drawing.Size(270, 29);
			...
			// groupBox14
			// 
			this.groupBox14.Controls.Add(this.btnSTileSet);
			this.groupBox14.Controls.Add(this.label1);
			this.groupBox14.Location = new System.Drawing.Point(1496, 22);
			...
			this.groupBox14.Size = new System.Drawing.Size(100, 75);
			...
			// btnSTileSet
			// 
			this.btnSTileSet.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			this.btnSTileSet.Location = new System.Drawing.Point(9, 16);
			this.btnSTileSet.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.btnSTileSet.Name = "btnSTileSet";
			this.btnSTileSet.Size = new System.Drawing.Size(20, 42);
			...
			this.ClientSize = new System.Drawing.Size(1656, 1127);
			this.Controls.Add(this.splitContainer1);
			this.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.Name = "IncidencePoolingandAggregation";
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Select and Pool Incidence Estimates";
			this.Load += new System.EventHandler(this.IncidencePoolingandAggregation_Load);
			...
			this.splitContainerTile.Panel1.ResumeLayout(false);
			this.splitContainerTile.Panel2.ResumeLayout(false);
			((System.ComponentModel.ISupportInitialize)(this.splitContainerTile)).EndInit();
			this.splitContainerTile.ResumeLayout(false);
			this.tabControlSelected.ResumeLayout(false);
			this.PoolingWindow0.ResumeLayout(false);
			((System.ComponentModel.ISupportInitialize)(this.treeListView)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.olvTile)).EndInit();
