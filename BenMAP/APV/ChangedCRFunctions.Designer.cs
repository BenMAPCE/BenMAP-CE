namespace BenMAP.APVX
{
	partial class ChangedCRFunctions
	{
		...
		private void InitializeComponent()
		{
			...
			this.grpAddCRFunctions = new System.Windows.Forms.GroupBox();
			...
			this.grpDelCRFunctions = new System.Windows.Forms.GroupBox();
			this.groupBox2 = new System.Windows.Forms.GroupBox();
			this.blvDelCRFunctions = new BrightIdeasSoftware.ObjectListView();
			this.olvColumn1 = ((BrightIdeasSoftware.OLVColumn)(new BrightIdeasSoftware.OLVColumn()));
			this.colEndPointGroup = ((BrightIdeasSoftware.OLVColumn)(new BrightIdeasSoftware.OLVColumn()));
			this.colDataSet = ((BrightIdeasSoftware.OLVColumn)(new BrightIdeasSoftware.OLVColumn()));
			...
			this.btnDelTitleSet = new System.Windows.Forms.Button();
			this.groupBox6 = new System.Windows.Forms.GroupBox();
			this.cboDelDataSet = new System.Windows.Forms.ComboBox();
			this.chkGroup = new System.Windows.Forms.CheckBox();
			this.label1 = new System.Windows.Forms.Label();
			this.cboDelView = new System.Windows.Forms.ComboBox();
			this.groupBox7 = new System.Windows.Forms.GroupBox();
			this.textBoxDelFilterSimple = new System.Windows.Forms.TextBox();
			this.groupBox11 = new System.Windows.Forms.GroupBox();
			this.cboDelEndPointGroup = new System.Windows.Forms.ComboBox();
			this.btnClose = new System.Windows.Forms.Button();
			((System.ComponentModel.ISupportInitialize)(this.spChangesCRFunctions)).BeginInit();
			this.spChangesCRFunctions.Panel1.SuspendLayout();
			this.spChangesCRFunctions.Panel2.SuspendLayout();
			this.spChangesCRFunctions.SuspendLayout();
			this.grpAddCRFunctions.SuspendLayout();
			...
			this.grpDelCRFunctions.SuspendLayout();
			this.groupBox2.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.blvDelCRFunctions)).BeginInit();
			...
			this.spChangesCRFunctions.Size = new System.Drawing.Size(958, 674);
			this.spChangesCRFunctions.SplitterDistance = 324;
			...
			this.grpAddCRFunctions.Location = new System.Drawing.Point(0, 0);
			this.grpAddCRFunctions.Name = "grpAddCRFunctions";
			this.grpAddCRFunctions.Size = new System.Drawing.Size(958, 324);
			this.grpAddCRFunctions.TabIndex = 0;
			...
			this.groupBox10.Size = new System.Drawing.Size(952, 234);
			...
			this.olvAvailable.AllColumns.Add(this.olvColumn3);
			...
			this.olvAvailable.BackColor = System.Drawing.Color.LightGray;
			...
			this.olvAvailable.Size = new System.Drawing.Size(946, 213);
			...
			this.cbView.Items.AddRange(new object[] {
						"Tile",
						"Details"});
			this.cbView.Location = new System.Drawing.Point(575, 28);
			...
			this.grpDelCRFunctions.Location = new System.Drawing.Point(0, 0);
			this.grpDelCRFunctions.Name = "grpDelCRFunctions";
			this.grpDelCRFunctions.Size = new System.Drawing.Size(958, 345);
			this.grpDelCRFunctions.TabIndex = 2;
...
"ser-specified CFGRX.";
			...
			this.blvDelCRFunctions.AllColumns.Add(this.olvColumn6);
			this.blvDelCRFunctions.AllColumns.Add(this.olvColumn7);
			this.blvDelCRFunctions.AllColumns.Add(this.olvColumn10);
			this.blvDelCRFunctions.AllColumns.Add(this.olvColumn11);
			this.blvDelCRFunctions.AllColumns.Add(this.olvColumn18);
			this.blvDelCRFunctions.AllColumns.Add(this.olvColumn19);
			this.blvDelCRFunctions.AllColumns.Add(this.olvColumn20);
			this.blvDelCRFunctions.AllColumns.Add(this.olvColumn21);
			this.blvDelCRFunctions.AllColumns.Add(this.olvColumn22);
			this.blvDelCRFunctions.AllColumns.Add(this.olvColumn23);
			this.blvDelCRFunctions.AllColumns.Add(this.olvColumn24);
			this.blvDelCRFunctions.AllColumns.Add(this.olvColumn25);
			this.blvDelCRFunctions.AllColumns.Add(this.olvColumn26);
			this.blvDelCRFunctions.AllColumns.Add(this.olvColumn27);
			this.blvDelCRFunctions.AllColumns.Add(this.olvColumn28);
			this.blvDelCRFunctions.AllColumns.Add(this.olvColumn29);
			this.blvDelCRFunctions.AllColumns.Add(this.olvColumn30);
			this.blvDelCRFunctions.AllColumns.Add(this.olvColumn31);
			this.blvDelCRFunctions.AllColumns.Add(this.olvColumn32);
			this.blvDelCRFunctions.AllColumns.Add(this.olvColumn33);
			this.blvDelCRFunctions.AllColumns.Add(this.olvColumn34);
			this.blvDelCRFunctions.AllColumns.Add(this.olvColumn53);
			this.blvDelCRFunctions.AllColumns.Add(this.olvColumn54);
			this.blvDelCRFunctions.AllColumns.Add(this.olvColumn55);
			this.blvDelCRFunctions.AllColumns.Add(this.olvColumn56);
			this.blvDelCRFunctions.AllColumns.Add(this.olvColumn4);
			this.blvDelCRFunctions.AllowColumnReorder = true;
			this.blvDelCRFunctions.AllowDrop = true;
			this.blvDelCRFunctions.AlternateRowBackColor = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(240)))), ((int)(((byte)(220)))));
			this.blvDelCRFunctions.CellEditActivation = BrightIdeasSoftware.ObjectListView.CellEditActivateMode.SingleClick;
			this.blvDelCRFunctions.CheckedAspectName = "";
			this.blvDelCRFunctions.Columns.AddRange(new System.Windows.Forms.ColumnHeader[] {
						this.olvColumn1,
						this.colEndPointGroup,
						this.olvColumn5,
						this.olvColumn6,
						this.olvColumn22});
			this.blvDelCRFunctions.CopySelectionOnControlC = false;
			this.blvDelCRFunctions.Cursor = System.Windows.Forms.Cursors.Default;
			this.blvDelCRFunctions.Dock = System.Windows.Forms.DockStyle.Fill;
			this.blvDelCRFunctions.EmptyListMsg = "This list is empty.";
			this.blvDelCRFunctions.FullRowSelect = true;
			this.blvDelCRFunctions.HeaderUsesThemes = false;
			this.blvDelCRFunctions.HideSelection = false;
			this.blvDelCRFunctions.IsSimpleDragSource = true;
			this.blvDelCRFunctions.IsSimpleDropSink = true;
			this.blvDelCRFunctions.Location = new System.Drawing.Point(3, 18);
			this.blvDelCRFunctions.Name = "blvDelCRFunctions";
			this.blvDelCRFunctions.OverlayText.Alignment = System.Drawing.ContentAlignment.BottomLeft;
			this.blvDelCRFunctions.OverlayText.BorderColor = System.Drawing.Color.FromArgb(((int)(((byte)(192)))), ((int)(((byte)(192)))), ((int)(((byte)(0)))));
			this.blvDelCRFunctions.OverlayText.BorderWidth = 2F;
			this.blvDelCRFunctions.OverlayText.Rotation = -20;
			this.blvDelCRFunctions.OverlayText.Text = "";
			this.blvDelCRFunctions.SelectColumnsOnRightClickBehaviour = BrightIdeasSoftware.ObjectListView.ColumnSelectBehaviour.Submenu;
			this.blvDelCRFunctions.ShowCommandMenuOnRightClick = true;
			this.blvDelCRFunctions.ShowGroups = false;
			this.blvDelCRFunctions.ShowImagesOnSubItems = true;
			this.blvDelCRFunctions.ShowItemCountOnGroups = true;
			this.blvDelCRFunctions.ShowItemToolTips = true;
			this.blvDelCRFunctions.Size = new System.Drawing.Size(946, 234);
			this.blvDelCRFunctions.SpaceBetweenGroups = 20;
			this.blvDelCRFunctions.TabIndex = 0;
			this.blvDelCRFunctions.UseAlternatingBackColors = true;
			this.blvDelCRFunctions.UseCompatibleStateImageBehavior = false;
			this.blvDelCRFunctions.UseFiltering = true;
			...
			this.groupBox4.Controls.Add(this.cboDelView);
			...
			this.cboDelDataSet.Name = "cboDelDataSet";
			...
			this.cboDelView.Items.AddRange(new object[] {
						"Tile",
						"Details"});
			this.cboDelView.Location = new System.Drawing.Point(575, 28);
			this.cboDelView.Name = "cboDelView";
			...
			this.textBoxDelFilterSimple.Location = new System.Drawing.Point(3, 18);
			...
			this.cboDelEndPointGroup.Name = "cboDelEndPointGroup";
			...
			this.Name = "ChangedCRFunctions";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Changed Health Impact Functions";
			this.Load += new System.EventHandler(this.ChangedCRFunctions_Load);
			this.spChangesCRFunctions.Panel1.ResumeLayout(false);
			this.spChangesCRFunctions.Panel2.ResumeLayout(false);
			((System.ComponentModel.ISupportInitialize)(this.spChangesCRFunctions)).EndInit();
			this.spChangesCRFunctions.ResumeLayout(false);
			this.grpAddCRFunctions.ResumeLayout(false);
			...
			this.grpDelCRFunctions.ResumeLayout(false);
			this.groupBox2.ResumeLayout(false);
			((System.ComponentModel.ISupportInitialize)(this.blvDelCRFunctions)).EndInit();
		...
		private System.Windows.Forms.GroupBox grpDelCRFunctions;
		private System.Windows.Forms.GroupBox groupBox2;
		public BrightIdeasSoftware.ObjectListView blvDelCRFunctions;
		private BrightIdeasSoftware.OLVColumn olvColumn1;
		private BrightIdeasSoftware.OLVColumn colEndPointGroup;
		private BrightIdeasSoftware.OLVColumn colDataSet;
		...
		private System.Windows.Forms.Button btnDelTitleSet;
		private System.Windows.Forms.GroupBox groupBox6;
		private System.Windows.Forms.ComboBox cboDelDataSet;
		private System.Windows.Forms.CheckBox chkGroup;
		private System.Windows.Forms.Label label1;
		private System.Windows.Forms.ComboBox cboDelView;
		private System.Windows.Forms.GroupBox groupBox7;
		private System.Windows.Forms.TextBox textBoxDelFilterSimple;
		private System.Windows.Forms.GroupBox groupBox11;
		private System.Windows.Forms.ComboBox cboDelEndPointGroup;
